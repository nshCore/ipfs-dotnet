...
namespace Ipfs.Server.HttpApi.V0
{
    ...
    public class SwarmController : IpfsController
    {
        ...
        public Task Connect(string arg) { return IpfsCore.Swarm.ConnectAsync(arg, Cancel); }
        ...
        public Task Disconnect(string arg) { return IpfsCore.Swarm.DisconnectAsync(arg, Cancel); }
    }
}
