...
namespace TheDotNetLeague.Ipfs.Abstractions
{
    ...
    /// </remarks>
    /// <seealso cref="Ipfs.Abstractions.ILinkedNode" />
    ...
    public interface IDagApi
    {
        ...
        ///     See <see cref="TheDotNetLeague.MultiFormats.MultiCodecs.MultiCodec" /> for more details.  Defaults to "dag-cbor".
        /// </param>
        /// <param name="multiHash">
        ///     The <see cref="TheDotNetLeague.MultiFormats.MultiHash.MultiHash" /> algorithm name used to produce the <see cref="Cid" />.
        /// </param>
        /// <param name="encoding">
        ///     The <see cref="TheDotNetLeague.MultiFormats.MultiBase.MultiBase" /> algorithm name used to produce the <see cref="Cid" />.
        /// </param>
        /// <param name="pin">
