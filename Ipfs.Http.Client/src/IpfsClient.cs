...
namespace TheDotNetLeague.Ipfs.Http.Client
{
    ...
    public partial class IpfsClient : ICoreApi
    {
        ...
        /// <summary>
        ///   Creates a new instance of the <see cref="Ipfs.Http.Client.IpfsClient"/> class and sets the
        ///   default values.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        ///   Creates a new instance of the <see cref="Ipfs.Http.Client.IpfsClient"/> class and specifies
