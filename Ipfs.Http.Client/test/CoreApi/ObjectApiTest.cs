...
namespace TheDotNetLeague.Ipfs.Http.Client.Tests.CoreApi
{
    ...
    public class ObjectApiTest
    {
        ...
        public async Task Put_Get_Dag()
        {
            ...
            Assert.AreEqual((object) beta.Links.Count(), node.Links.Count());
            Assert.AreEqual((object) beta.Links.First().Id, node.Links.First().Id);
            Assert.AreEqual((object) beta.Links.First().Name, node.Links.First().Name);
            Assert.AreEqual((object) beta.Links.First().Size, node.Links.First().Size);
        }
        ...
        public async Task Links()
        {
            ...
            Assert.AreEqual((object) beta.Links.Count(),links.Count());
            Assert.AreEqual((object) beta.Links.First().Id, links.First().Id);
            Assert.AreEqual((object) beta.Links.First().Name, links.First().Name);
            Assert.AreEqual((object) beta.Links.First().Size, links.First().Size);
        }
