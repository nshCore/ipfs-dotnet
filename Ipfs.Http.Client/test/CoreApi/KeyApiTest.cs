...
namespace Ipfs.Http.Client.Tests.CoreApi
{
    ...
    public class KeyApiTest
    {
        ...
        public async Task Self_Key_Exists()
        {
            ...
            Assert.AreEqual((object) me.Id, self.Id);
        }
        ...
        public async Task Create_RSA_Key()
        {
            ...
            try
            {
                ...
                Assert.AreEqual((object) key.Name, clone.Name);
                Assert.AreEqual((object) key.Id, clone.Id);
            }
            finally
            {
        ...
        public async Task Remove_Key()
        {
            ...
            Assert.AreEqual((object) key.Name, removed.Name);
            Assert.AreEqual((object) key.Id, removed.Id);
        ...
        public async Task Rename_Key()
        {
            ...
            try
            {
                ...
                Assert.AreEqual((object) okey.Id, rkey.Id);
