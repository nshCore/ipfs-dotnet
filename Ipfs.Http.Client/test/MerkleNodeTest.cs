...
namespace TheDotNetLeague.Ipfs.Http.Client.Tests
{
    ...
    public partial class MerkleNodeTest
    {
        ...
        public void FromALink()
        {
            ...
            Assert.AreEqual((object) link.Id, node.Links.First().Id);
            Assert.AreEqual((object) link.Name, node.Links.First().Name);
            Assert.AreEqual((object) link.BlockSize, node.Links.First().Size);
        }
        ...
        public void ToALink()
        {
            ...
            Assert.AreEqual((object) link.Id, node.Id);
            Assert.AreEqual((object) link.Name, node.Name);
            Assert.AreEqual((object) link.Size, node.BlockSize);
        ...
        public void Value_Equality()
        {
            ...
            Assert.AreEqual((object) a0.GetHashCode(), a0.GetHashCode());
            Assert.AreEqual((object) a0.GetHashCode(), a1.GetHashCode());
            Assert.AreNotEqual((object) a0.GetHashCode(), b.GetHashCode());
