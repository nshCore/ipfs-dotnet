...
namespace Ipfs.Core.Lib.CoreApi
{
    ...
    public class AddFileOptions
    {
        ...
        /// </summary>
        /// <value>
        ///     The <see cref="TheDotNetLeague.MultiFormats.MultiHash.MultiHash" /> algorithm name used to produce the
        ///     <see cref="Cid" />.
        ///     Defaults to <see cref="TheDotNetLeague.MultiFormats.MultiHash.MultiHash.DefaultAlgorithmName" />.
        /// </value>
        /// <seealso cref="TheDotNetLeague.MultiFormats.MultiHash.MultiHash" />
        ...
        /// </remarks>
        /// <seealso cref="Ipfs.Abstractions.IKeyApi" />
