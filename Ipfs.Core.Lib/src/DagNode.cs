...
namespace TheDotNetLeague.Ipfs.Core.Lib
{
    ...
    /// </remarks>
    [DataContract]
    public class DagNode : Ipfs.Abstractions.IMerkleNode<Abstractions.IMerkleLink>
    {
        ...
        ///     <see cref="TheDotNetLeague.MultiFormats.MultiHash.MultiHash.DefaultAlgorithmName" />.
        /// </param>
        ...
        public Cid Id
        {
            ...
            {
                id = value;
                if (id != null) hashAlgorithm = id.Hash.Algorithm.Name;
            }
        }
