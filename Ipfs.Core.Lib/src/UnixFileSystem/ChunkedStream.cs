...
namespace TheDotNetLeague.Ipfs.Core.Lib.UnixFileSystem
{
    ...
    public class ChunkedStream : Stream
    {
        ...
        ///     the specified <see cref="Ipfs.Abstractions.IBlockApi" /> and <see cref="DagNode" />.
        /// </summary>
        ...
        {
            if (position >= Length) return new ArraySegment<byte>();
            ...
            var offset = (int) (position - currentBlock.Position);
