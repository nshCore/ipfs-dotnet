...
namespace TheDotNetLeague.Ipfs.Cli.Commands
{
    ...
    {
        private static readonly AddFileOptions DefaultOptions = new AddFileOptions();
        ...
        protected override async Task<int> OnExecute(CommandLineApplication app)
        {
            ...
            if (Progress)
                options.Progress = new Progress<TransferProgress>(t => { Console.WriteLine($"{t.Name} {t.Bytes}"); });
